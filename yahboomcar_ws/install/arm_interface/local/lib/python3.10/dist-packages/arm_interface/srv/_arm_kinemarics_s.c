...
bool arm_interface__srv__arm_kinemarics__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arm_interface.srv._arm_kinemarics.ArmKinemarics_Request", full_classname_dest, 55) == 0);
  }
  arm_interface__srv__ArmKinemarics_Request * ros_message = _ros_message;
  {  // tar_x
...
{
  /* NOTE(esteve): Call constructor of ArmKinemarics_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("arm_interface.srv._arm_kinemarics");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArmKinemarics_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool arm_interface__srv__arm_kinemarics__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arm_interface.srv._arm_kinemarics.ArmKinemarics_Response", full_classname_dest, 56) == 0);
  }
  arm_interface__srv__ArmKinemarics_Response * ros_message = _ros_message;
  {  // joint1
...
{
  /* NOTE(esteve): Call constructor of ArmKinemarics_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("arm_interface.srv._arm_kinemarics");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArmKinemarics_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
