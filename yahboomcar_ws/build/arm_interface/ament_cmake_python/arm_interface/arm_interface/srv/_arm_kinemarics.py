...
class Metaclass_ArmKinemarics_Request(type):
    """Metaclass of message 'ArmKinemarics_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'arm_interface.srv.ArmKinemarics_Request')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__arm_kinemarics__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__arm_kinemarics__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__arm_kinemarics__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__arm_kinemarics__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__arm_kinemarics__request
...
class ArmKinemarics_Request(metaclass=Metaclass_ArmKinemarics_Request):
    """Message class 'ArmKinemarics_Request'."""
...
class Metaclass_ArmKinemarics_Response(type):
    """Metaclass of message 'ArmKinemarics_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'arm_interface.srv.ArmKinemarics_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__arm_kinemarics__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__arm_kinemarics__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__arm_kinemarics__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__arm_kinemarics__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__arm_kinemarics__response
...
class ArmKinemarics_Response(metaclass=Metaclass_ArmKinemarics_Response):
    """Message class 'ArmKinemarics_Response'."""
...
class Metaclass_ArmKinemarics(type):
    """Metaclass of service 'ArmKinemarics'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'arm_interface.srv.ArmKinemarics')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__arm_kinemarics

            from arm_interface.srv import _arm_kinemarics
            if _arm_kinemarics.Metaclass_ArmKinemarics_Request._TYPE_SUPPORT is None:
                _arm_kinemarics.Metaclass_ArmKinemarics_Request.__import_type_support__()
            if _arm_kinemarics.Metaclass_ArmKinemarics_Response._TYPE_SUPPORT is None:
                _arm_kinemarics.Metaclass_ArmKinemarics_Response.__import_type_support__()


class ArmKinemarics(metaclass=Metaclass_ArmKinemarics):
    from arm_interface.srv._arm_kinemarics import ArmKinemarics_Request as Request
    from arm_interface.srv._arm_kinemarics import ArmKinemarics_Response as Response
