...
bool arm_interface__msg__yolov5_detect__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arm_interface.msg._yolov5_detect.Yolov5Detect", full_classname_dest, 45) == 0);
  }
  arm_interface__msg__Yolov5Detect * ros_message = _ros_message;
  {  // result
...
{
  /* NOTE(esteve): Call constructor of Yolov5Detect */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("arm_interface.msg._yolov5_detect");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Yolov5Detect");
