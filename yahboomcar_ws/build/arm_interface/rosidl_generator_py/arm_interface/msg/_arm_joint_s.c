...
bool arm_interface__msg__arm_joint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("arm_interface.msg._arm_joint.ArmJoint", full_classname_dest, 37) == 0);
  }
  arm_interface__msg__ArmJoint * ros_message = _ros_message;
  {  // id
  ...
  {  // joints
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      float * dest = ros_message->joints.data;
...
PyObject * arm_interface__msg__arm_joint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("arm_interface.msg._arm_joint");
  ...
  {  // joints
    ...
    if (ros_message->joints.size > 0) {
      ...
      float * src = &(ros_message->joints.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->joints.size * sizeof(float));
      assert(data != NULL);
