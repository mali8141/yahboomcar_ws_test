...
#include "arm_interface/msg/detail/shape_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_interface::msg::ShapeInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_interface::msg::ShapeInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_interface::msg::ShapeInfo *>(
    untyped_ros_message);
...
{
  return &arm_interface::msg::typesupport_fastrtps_cpp::_ShapeInfo__handle;
}
