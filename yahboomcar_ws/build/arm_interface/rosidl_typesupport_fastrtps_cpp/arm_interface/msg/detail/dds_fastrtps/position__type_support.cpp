...
#include "arm_interface/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const arm_interface::msg::Position & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arm_interface::msg::Position & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_interface::msg::Position;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const arm_interface::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_interface::msg::Position *>(
    untyped_ros_message);
...
{
  return &arm_interface::msg::typesupport_fastrtps_cpp::_Position__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_interface, msg, Position)() {
  return &arm_interface::msg::typesupport_fastrtps_cpp::_Position__handle;
}
