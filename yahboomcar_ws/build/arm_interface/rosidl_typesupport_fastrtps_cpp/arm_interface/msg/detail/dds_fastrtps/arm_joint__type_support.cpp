...
#include "arm_interface/msg/detail/arm_joint__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const arm_interface::msg::ArmJoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arm_interface::msg::ArmJoint & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_interface::msg::ArmJoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_interface::msg::ArmJoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_interface::msg::ArmJoint *>(
    untyped_ros_message);
...
{
  return &arm_interface::msg::typesupport_fastrtps_cpp::_ArmJoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_interface, msg, ArmJoint)() {
  return &arm_interface::msg::typesupport_fastrtps_cpp::_ArmJoint__handle;
}
