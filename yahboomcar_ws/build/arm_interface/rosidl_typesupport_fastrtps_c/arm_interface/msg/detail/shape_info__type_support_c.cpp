...
#include "arm_interface/msg/detail/shape_info__rosidl_typesupport_fastrtps_c.h"
...
using _ShapeInfo__ros_msg_type = arm_interface__msg__ShapeInfo;
...
size_t get_serialized_size_arm_interface__msg__ShapeInfo(
  const void * untyped_ros_message,
...
static uint32_t _ShapeInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_arm_interface__msg__ShapeInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_arm_interface
size_t max_serialized_size_arm_interface__msg__ShapeInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_interface__msg__ShapeInfo;
    is_plain =
      (
...
static size_t _ShapeInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_arm_interface__msg__ShapeInfo(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, arm_interface, msg, ShapeInfo)() {
