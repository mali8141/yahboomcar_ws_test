...
{
  new (message_memory) arm_msgs::msg::ArmJoint(_init);
}

void ArmJoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<arm_msgs::msg::ArmJoint *>(message_memory);
  typed_message->~ArmJoint();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ArmJoint_message_member_array[3] = {
  {
    "id",  // name
    ...
    offsetof(arm_msgs::msg::ArmJoint, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(arm_msgs::msg::ArmJoint, joint),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(arm_msgs::msg::ArmJoint, time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::arm_msgs::msg::rosidl_typesupport_introspection_cpp::ArmJoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, arm_msgs, msg, ArmJoint)() {
  return &::arm_msgs::msg::rosidl_typesupport_introspection_cpp::ArmJoint_message_type_support_handle;
}
